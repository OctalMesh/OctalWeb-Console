          ...
          {sortedConversations.map((conversation) => (
            ...
            >
              ...
              <div className="relative flex-shrink-0">
                <Avatar
                  className={cn("h-12 w-12", selectedConversation === conversation.id && "ring-2 ring-background")}
                >
              ...
              <div className="flex-1 min-w-0 overflow-hidden">
                <div className="flex items-center justify-between mb-1 min-w-0">
                  <div className="flex items-center gap-1 min-w-0 flex-1 overflow-hidden">
                    ...
                    {conversation.isPinned && <Pin className="h-3 w-3 text-muted-foreground flex-shrink-0" />}
                    {conversation.isMuted && <VolumeX className="h-3 w-3 text-muted-foreground flex-shrink-0" />}
                  </div>
              ...
              <div className="opacity-0 group-hover:opacity-100 ml-2 flex-shrink-0">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem className="cursor-pointer text-destructive">Delete conversation</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </div>
            </div>
