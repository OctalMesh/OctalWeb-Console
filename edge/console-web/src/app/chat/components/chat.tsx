...
import { type Conversation, type Message, useChat, type User } from "@/app/chat/use-chat";
      ...
      <div className="h-full min-h-[600px] max-h-[calc(100vh-200px)] flex rounded-lg border overflow-hidden bg-background">
        ...
        >
          ...
          <div className="lg:hidden p-4 border-b flex items-center justify-between bg-background">
            ...
            <Button variant="ghost" size="sm" onClick={() => setIsSidebarOpen(false)} className="cursor-pointer">
              <X className="h-4 w-4" />
            </Button>
          </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-background">
          ...
          <div className="flex items-center h-16 px-4 border-b bg-background">
            ...
            <div className="flex-1">
              <ChatHeader conversation={currentConversation || null} users={users} onToggleMute={handleToggleMute} />
            </div>
          </div>
