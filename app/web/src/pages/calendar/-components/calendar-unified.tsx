...
import calendarsData from "@pages/calendar/-data/calendars.json";
// Import -data
import eventsData from "@pages/calendar/-data/events.json";
        ...
        <div className="grid grid-cols-7 min-h-[600px]">
          {calendarDays.map((day) => {
            ...
            return (
              ...
              >
                {/* Date Number */}
                <div className={cn("text-sm font-medium mb-1", isDayToday && "text-blue-600 dark:text-blue-400")}>
                  {format(day, "d")}
                </div>
          ...
          <div className="border-b bg-background px-4 py-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                {/* Mobile Menu Button */}
                <Button variant="ghost" size="sm" className="xl:hidden" onClick={() => setShowCalendarSheet(true)}>
